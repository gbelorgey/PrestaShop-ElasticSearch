...
class ElasticMenuSearchTemplate extends ObjectModel
{
    public $id;

    public $id_elasticsearch_menu_template = 0;
    ...
    public static $definition = array(
        'table' => 'elasticsearch_menu_template',
        'primary' => 'id_elasticsearch_menu_template',
        'fields' => array(
