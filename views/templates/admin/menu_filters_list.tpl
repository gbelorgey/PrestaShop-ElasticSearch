...
<div class="panel">
		...
		<div class="row">
			<table class="table">
				...
				{foreach $filters_templates as $template}
					<tr>
						<td class="center">{$template['id_elasticsearch_menu_template']|intval}</td>
							...
							{if empty($limit_warning)}
								<div class="btn-group-action">
									<div class="btn-group pull-right">
										<a href="{$current_url}&menu=manage_menu_filter_template&id_elasticsearch_menu_template={$template['id_elasticsearch_menu_template']|intval}" class="btn btn-default">
										...
										<ul class="dropdown-menu">
											<li>
												<a href="{$current_url}&menu=filter&deleteMenuFilterTemplate=1&id_elasticsearch_menu_template={$template['id_elasticsearch_menu_template']|intval}"
	...
	{if empty($limit_warning)}
		<div class="panel-footer">
			<a class="btn btn-default pull-right" href="{$current_url|escape:'htmlall':'UTF-8'}&menu=manage_menu_filter_template">
