                ...
                <div>
                    ...
                    {if isset($subcategories) && count($subcategories) > 0}
                        <div class="elasticsearch__block">
                            <div class="elasticsearch__block__title elasticsearch__block__title--expanded elasticsearch__block__title__category js-filter-toggle js-filter-subcategories">
